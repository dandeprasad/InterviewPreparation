...
//Insert
//1. root  = k-1/2  2. left 2*k+1 3. right 2*k+2
//3. Insert & check with parent if less then swap

//delete
////1. Insert Integer.min value & swap with parent to make small value to top
////2. Insert last element to at the heap[0] and decrease size
////3. check childs & trasfer the min value from parent
