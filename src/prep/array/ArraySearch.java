...
/*
1.This is sorted array
2.compare arr1 & arr2 ; store the common elements in temp array
3.use the temp & arr3 to find remaining
4. here logic is 2 pointers from 0 more forward based on array max value
when equals stores the value

Main condition while (i < m && j < n)*/
